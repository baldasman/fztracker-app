...
var Tab1Page = /** @class */ (function () {
    function Tab1Page(httpClient, nfc, ndef, changeRef) {
        var _this = this;
        ...
        this.nfc.addNdefListener(function () {
            ...
            if (uid == "044ac5caa46581") {
                _this.photo = "/assets/oscar1.jpg";
                _this.rankName = "1SAR FZ Rui Bastos";
                _this.polo = "EF";
                ...
                _this.photo = "/assets/oscar2.jpg";
                _this.rankName = "CIVIL Mariana Teixeira";
                _this.polo = "EF";
                _this.changeRef.detectChanges();
            }
        });
    }
    Tab1Page.prototype.logAccess = function (cardId) {
        var _this = this;
        // Call API
        var params = {
            location: "123456789",
        ...
        var card = this.httpClient.post('http://192.168.2.10:8000/fztracker/v1/entities/movement', params, options);
        card.subscribe(function (response) {
            var data = response;
            console.log('my data: ', data);
            //ver isto !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 
            _this.photo = "http://192.168.1.168:8081/img/militares/" + data.entity.permanent.serial + ".jpg";
            _this.rankName = data.entity.nopermanent.rank + " " + data.entity.permanent.name;
            _this.polo = data.entity.nopermanent.polo;
            _this.gdh = (data.entity.inOut ? "Entrada" : "Saída") + " \u00E0s " + moment__WEBPACK_IMPORTED_MODULE_4__(data.entity.lastMovementDate).format("DD-MM-YYYY HH:mm");
            _this.changeRef.detectChanges();
        }, function (error) {
